...
function cache_cards(data_json){
...
const applicationServerPublicKey = 'BADDMNaOc-XBLrdiF0S48xg280IX3Ulge0kjeCrvO4BLzDphCDifRKjQYfEHOY0B4S74-QIPygj4OvFAq1qi_ck';
const pushButton = document.getElementById('butPush');
 
 
function initialiseUI() {
    console.log("inicial push")
